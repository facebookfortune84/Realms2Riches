...
def test_forge_launch_readiness():
    ...
    with TestClient(app) as client:
        ...
        task_payload = {"description": "Test task from launch check", "project_id": "test"}
        # Note: TaskSpec expects id, project_id, description. id is generated by orchestrator usually but here we post
        resp = client.post("/api/tasks", json={"id": "test-id", "project_id": "test", "description": "Test task"})
